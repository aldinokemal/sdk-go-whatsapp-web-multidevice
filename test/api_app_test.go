...
func Test_SdkWhatsappWebMultiDevice_AppAPIService(t *testing.T) {
	...
	t.Run("Test AppAPIService AppStatus", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.AppAPI.AppStatus(context.Background()).Execute()
