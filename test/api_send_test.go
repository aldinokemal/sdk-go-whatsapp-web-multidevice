...
func Test_SdkWhatsappWebMultiDevice_SendAPIService(t *testing.T) {
	...
	t.Run("Test SendAPIService SendChatPresence", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.SendAPI.SendChatPresence(context.Background()).Execute()
	...
	t.Run("Test SendAPIService SendPresence", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.SendAPI.SendPresence(context.Background()).Execute()
	...
	t.Run("Test SendAPIService SendSticker", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.SendAPI.SendSticker(context.Background()).Execute()
