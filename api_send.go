...
func (r ApiSendAudioRequest) XDeviceId(xDeviceId string) ApiSendAudioRequest {
...
// Audio URL to send
func (r ApiSendAudioRequest) AudioUrl(audioUrl string) ApiSendAudioRequest {
	r.audioUrl = &audioUrl
	return r
}

// Whether this is a forwarded message
func (r ApiSendAudioRequest) IsForwarded(isForwarded bool) ApiSendAudioRequest {
	r.isForwarded = &isForwarded
	return r
}

// Disappearing message duration in seconds (optional)
func (r ApiSendAudioRequest) Duration(duration int32) ApiSendAudioRequest {
	r.duration = &duration
	return r
}
...
func (a *SendAPIService) SendAudioExecute(r ApiSendAudioRequest) (*SendResponse, *http.Response, error) {
	...
	if r.isForwarded != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "is_forwarded", r.isForwarded, "", "")
	}
	if r.duration != nil {
...
type ApiSendChatPresenceRequest struct {
	ctx context.Context
	ApiService *SendAPIService
	sendChatPresenceRequest *SendChatPresenceRequest
	xDeviceId *string
}

func (r ApiSendChatPresenceRequest) SendChatPresenceRequest(sendChatPresenceRequest SendChatPresenceRequest) ApiSendChatPresenceRequest {
	r.sendChatPresenceRequest = &sendChatPresenceRequest
	return r
}

// Device identifier for multi-device support. Required when multiple devices are registered. If only one device is registered, it will be used as the default. Can also be provided as &#x60;device_id&#x60; query parameter. 
func (r ApiSendChatPresenceRequest) XDeviceId(xDeviceId string) ApiSendChatPresenceRequest {
	r.xDeviceId = &xDeviceId
	return r
}

func (r ApiSendChatPresenceRequest) Execute() (*SendResponse, *http.Response, error) {
	return r.ApiService.SendChatPresenceExecute(r)
}

/*
SendChatPresence Send chat presence (typing indicator)

Send typing indicator to start or stop showing that you are composing a message

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSendChatPresenceRequest
*/
func (a *SendAPIService) SendChatPresence(ctx context.Context) ApiSendChatPresenceRequest {
	return ApiSendChatPresenceRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return SendResponse
func (a *SendAPIService) SendChatPresenceExecute(r ApiSendChatPresenceRequest) (*SendResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SendAPIService.SendChatPresence")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/send/chat-presence"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.sendChatPresenceRequest == nil {
		return localVarReturnValue, nil, reportError("sendChatPresenceRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.sendChatPresenceRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
// Device identifier for multi-device support. Required when multiple devices are registered. If only one device is registered, it will be used as the default. Can also be provided as &#x60;device_id&#x60; query parameter. 
func (r ApiSendContactRequest) XDeviceId(xDeviceId string) ApiSendContactRequest {
	r.xDeviceId = &xDeviceId
	return r
}
...
// Device identifier for multi-device support. Required when multiple devices are registered. If only one device is registered, it will be used as the default. Can also be provided as &#x60;device_id&#x60; query parameter. 
func (r ApiSendFileRequest) XDeviceId(xDeviceId string) ApiSendFileRequest {
	r.xDeviceId = &xDeviceId
	return r
}
...
// Whether this is a forwarded message
func (r ApiSendFileRequest) IsForwarded(isForwarded bool) ApiSendFileRequest {
	r.isForwarded = &isForwarded
	return r
}

// Disappearing message duration in seconds (optional)
func (r ApiSendFileRequest) Duration(duration int32) ApiSendFileRequest {
	r.duration = &duration
	return r
}
...
// Device identifier for multi-device support. Required when multiple devices are registered. If only one device is registered, it will be used as the default. Can also be provided as &#x60;device_id&#x60; query parameter. 
func (r ApiSendImageRequest) XDeviceId(xDeviceId string) ApiSendImageRequest {
	r.xDeviceId = &xDeviceId
	return r
}
...
// Image URL to send
func (r ApiSendImageRequest) ImageUrl(imageUrl string) ApiSendImageRequest {
	r.imageUrl = &imageUrl
	return r
}
...
// Disappearing message duration in seconds (optional)
func (r ApiSendImageRequest) Duration(duration int32) ApiSendImageRequest {
	r.duration = &duration
	return r
}

// Whether this is a forwarded message
func (r ApiSendImageRequest) IsForwarded(isForwarded bool) ApiSendImageRequest {
	r.isForwarded = &isForwarded
	return r
}
...
// Device identifier for multi-device support. Required when multiple devices are registered. If only one device is registered, it will be used as the default. Can also be provided as &#x60;device_id&#x60; query parameter. 
func (r ApiSendLinkRequest) XDeviceId(xDeviceId string) ApiSendLinkRequest {
	r.xDeviceId = &xDeviceId
	return r
}
...
// Device identifier for multi-device support. Required when multiple devices are registered. If only one device is registered, it will be used as the default. Can also be provided as &#x60;device_id&#x60; query parameter. 
func (r ApiSendLocationRequest) XDeviceId(xDeviceId string) ApiSendLocationRequest {
	r.xDeviceId = &xDeviceId
	return r
}
...
// Device identifier for multi-device support. Required when multiple devices are registered. If only one device is registered, it will be used as the default. Can also be provided as &#x60;device_id&#x60; query parameter. 
func (r ApiSendMessageRequest) XDeviceId(xDeviceId string) ApiSendMessageRequest {
	r.xDeviceId = &xDeviceId
	return r
}
...
// Device identifier for multi-device support. Required when multiple devices are registered. If only one device is registered, it will be used as the default. Can also be provided as &#x60;device_id&#x60; query parameter. 
func (r ApiSendPollRequest) XDeviceId(xDeviceId string) ApiSendPollRequest {
	r.xDeviceId = &xDeviceId
	return r
}
...
// Device identifier for multi-device support. Required when multiple devices are registered. If only one device is registered, it will be used as the default. Can also be provided as &#x60;device_id&#x60; query parameter. 
func (r ApiSendPresenceRequest) XDeviceId(xDeviceId string) ApiSendPresenceRequest {
	r.xDeviceId = &xDeviceId
	return r
}
...
// Device identifier for multi-device support. Required when multiple devices are registered. If only one device is registered, it will be used as the default. Can also be provided as &#x60;device_id&#x60; query parameter. 
func (r ApiSendStickerRequest) XDeviceId(xDeviceId string) ApiSendStickerRequest {
	r.xDeviceId = &xDeviceId
	return r
}

// Phone number with country code
func (r ApiSendStickerRequest) Phone(phone string) ApiSendStickerRequest {
	r.phone = &phone
	return r
}

// Sticker image file (jpg/jpeg/png/webp/gif)
func (r ApiSendStickerRequest) Sticker(sticker *os.File) ApiSendStickerRequest {
	r.sticker = sticker
	return r
}

// URL of sticker image to send
func (r ApiSendStickerRequest) StickerUrl(stickerUrl string) ApiSendStickerRequest {
	r.stickerUrl = &stickerUrl
	return r
}

// Disappearing message duration in seconds (optional)
func (r ApiSendStickerRequest) Duration(duration int32) ApiSendStickerRequest {
	r.duration = &duration
	return r
}

// Whether this is a forwarded sticker
func (r ApiSendStickerRequest) IsForwarded(isForwarded bool) ApiSendStickerRequest {
	r.isForwarded = &isForwarded
	return r
}

func (r ApiSendStickerRequest) Execute() (*SendResponse, *http.Response, error) {
...
*/
func (a *SendAPIService) SendSticker(ctx context.Context) ApiSendStickerRequest {
	return ApiSendStickerRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return SendResponse
func (a *SendAPIService) SendStickerExecute(r ApiSendStickerRequest) (*SendResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SendAPIService.SendSticker")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/send/sticker"
	...
	var stickerLocalVarFormFileName string
	var stickerLocalVarFileName     string
	var stickerLocalVarFileBytes    []byte

	stickerLocalVarFormFileName = "sticker"
	stickerLocalVarFile := r.sticker

	if stickerLocalVarFile != nil {
		fbs, _ := io.ReadAll(stickerLocalVarFile)

		stickerLocalVarFileBytes = fbs
		stickerLocalVarFileName = stickerLocalVarFile.Name()
		stickerLocalVarFile.Close()
		formFiles = append(formFiles, formFile{fileBytes: stickerLocalVarFileBytes, fileName: stickerLocalVarFileName, formFileName: stickerLocalVarFormFileName})
	}
	if r.stickerUrl != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "sticker_url", r.stickerUrl, "", "")
	}
	if r.duration != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "duration", r.duration, "", "")
	}
...
// Device identifier for multi-device support. Required when multiple devices are registered. If only one device is registered, it will be used as the default. Can also be provided as &#x60;device_id&#x60; query parameter. 
func (r ApiSendVideoRequest) XDeviceId(xDeviceId string) ApiSendVideoRequest {
	r.xDeviceId = &xDeviceId
	return r
}
...
// Video URL to send
func (r ApiSendVideoRequest) VideoUrl(videoUrl string) ApiSendVideoRequest {
	r.videoUrl = &videoUrl
	return r
}
...
// Disappearing message duration in seconds (optional)
func (r ApiSendVideoRequest) Duration(duration int32) ApiSendVideoRequest {
	r.duration = &duration
	return r
}

// Whether this is a forwarded message
func (r ApiSendVideoRequest) IsForwarded(isForwarded bool) ApiSendVideoRequest {
	r.isForwarded = &isForwarded
	return r
}
