...
// APIClient manages communication with the WhatsApp API MultiDevice API v8.3.0
...
type APIClient struct {
	...
	ChatwootAPI *ChatwootAPIService
	...
	NewsletterAPI *NewsletterAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.ChatwootAPI = (*ChatwootAPIService)(&c.common)
