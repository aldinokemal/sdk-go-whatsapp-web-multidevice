...
func (r ApiUserInfoRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *UserApiService) UserInfoExecute(r ApiUserInfoRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiUserMyPrivacyRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *UserApiService) UserMyPrivacyExecute(r ApiUserMyPrivacyRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
