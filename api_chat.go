...
type ApiArchiveChatRequest struct {
	ctx context.Context
...
func (r ApiArchiveChatRequest) XDeviceId(xDeviceId string) ApiArchiveChatRequest {
	r.xDeviceId = &xDeviceId
	return r
}

func (r ApiArchiveChatRequest) ArchiveChatRequest(archiveChatRequest ArchiveChatRequest) ApiArchiveChatRequest {
	r.archiveChatRequest = &archiveChatRequest
	return r
}

func (r ApiArchiveChatRequest) Execute() (*ArchiveChatResponse, *http.Response, error) {
	return r.ApiService.ArchiveChatExecute(r)
}
...
Archive or unarchive a chat conversation. Archived chats are hidden from the main chat list.
 ...
 @return ApiArchiveChatRequest
*/
func (a *ChatAPIService) ArchiveChat(ctx context.Context, chatJid string) ApiArchiveChatRequest {
	return ApiArchiveChatRequest{
		ApiService: a,
		ctx: ctx,
		chatJid: chatJid,
...
func (a *ChatAPIService) ArchiveChatExecute(r ApiArchiveChatRequest) (*ArchiveChatResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ArchiveChatResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ChatAPIService.ArchiveChat")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/chat/{chat_jid}/archive"
	...
	// body params
	localVarPostBody = r.archiveChatRequest
...
// Device identifier for multi-device support. Required when multiple devices are registered. If only one device is registered, it will be used as the default. Can also be provided as &#x60;device_id&#x60; query parameter. 
func (r ApiGetChatMessagesRequest) XDeviceId(xDeviceId string) ApiGetChatMessagesRequest {
	r.xDeviceId = &xDeviceId
	return r
}
...
// Device identifier for multi-device support. Required when multiple devices are registered. If only one device is registered, it will be used as the default. Can also be provided as &#x60;device_id&#x60; query parameter. 
func (r ApiLabelChatRequest) XDeviceId(xDeviceId string) ApiLabelChatRequest {
	r.xDeviceId = &xDeviceId
	return r
}
...
// Device identifier for multi-device support. Required when multiple devices are registered. If only one device is registered, it will be used as the default. Can also be provided as &#x60;device_id&#x60; query parameter. 
func (r ApiListChatsRequest) XDeviceId(xDeviceId string) ApiListChatsRequest {
	r.xDeviceId = &xDeviceId
	return r
}
...
// Filter by archived status. true &#x3D; archived only, false &#x3D; non-archived only. Omit to return all chats.
func (r ApiListChatsRequest) Archived(archived bool) ApiListChatsRequest {
	r.archived = &archived
	return r
}
...
// Device identifier for multi-device support. Required when multiple devices are registered. If only one device is registered, it will be used as the default. Can also be provided as &#x60;device_id&#x60; query parameter. 
func (r ApiPinChatRequest) XDeviceId(xDeviceId string) ApiPinChatRequest {
	r.xDeviceId = &xDeviceId
	return r
}
...
type ApiSetDisappearingTimerRequest struct {
	ctx context.Context
	ApiService *ChatAPIService
	chatJid string
	xDeviceId *string
	setDisappearingTimerRequest *SetDisappearingTimerRequest
}

// Device identifier for multi-device support. Required when multiple devices are registered. If only one device is registered, it will be used as the default. Can also be provided as &#x60;device_id&#x60; query parameter. 
func (r ApiSetDisappearingTimerRequest) XDeviceId(xDeviceId string) ApiSetDisappearingTimerRequest {
	r.xDeviceId = &xDeviceId
	return r
}

func (r ApiSetDisappearingTimerRequest) SetDisappearingTimerRequest(setDisappearingTimerRequest SetDisappearingTimerRequest) ApiSetDisappearingTimerRequest {
	r.setDisappearingTimerRequest = &setDisappearingTimerRequest
	return r
}

func (r ApiSetDisappearingTimerRequest) Execute() (*SetDisappearingTimerResponse, *http.Response, error) {
	return r.ApiService.SetDisappearingTimerExecute(r)
}

/*
SetDisappearingTimer Set disappearing messages timer

Set or disable disappearing messages for a chat. Valid timer values are 0 (off), 86400 (24h), 604800 (7d), 7776000 (90d).

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param chatJid Chat JID (e.g., phone@s.whatsapp.net for individual or groupid@g.us for group)
 @return ApiSetDisappearingTimerRequest
*/
func (a *ChatAPIService) SetDisappearingTimer(ctx context.Context, chatJid string) ApiSetDisappearingTimerRequest {
	return ApiSetDisappearingTimerRequest{
		ApiService: a,
		ctx: ctx,
		chatJid: chatJid,
...
// Execute executes the request
//  @return SetDisappearingTimerResponse
func (a *ChatAPIService) SetDisappearingTimerExecute(r ApiSetDisappearingTimerRequest) (*SetDisappearingTimerResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SetDisappearingTimerResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ChatAPIService.SetDisappearingTimer")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/chat/{chat_jid}/disappearing"
	localVarPath = strings.Replace(localVarPath, "{"+"chat_jid"+"}", url.PathEscape(parameterValueToString(r.chatJid, "chatJid")), -1)
	...
	// body params
	localVarPostBody = r.setDisappearingTimerRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
